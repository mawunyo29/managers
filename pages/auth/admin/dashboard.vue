        ...
        <div class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
          <article class="mb-5">
            ...
            <p class="mb-2 text-gray-900 dark:text-white">
              ...
              Let's schedule a kick-off meeting and workshop this week. It would be great to gather everyone involved in
          ...
          <article class="pl-12 mb-5">
            ...
            <p class="mb-2 text-gray-900 dark:text-white">
              Hello <a href="#" class="font-medium hover:underline text-primary-600 dark:text-primary-500">@jeseleos</a> I
          ...
          <article class="pl-12 mb-5">
            ...
            <p class="mb-4 text-gray-900 dark:text-white">
              Hi <a href="#" class="font-medium hover:underline text-primary-600 dark:text-primary-500">@josephh</a> Sure,
