        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <div class="flex items-center justify-between py-4">
            <div class="flex flex-col flex-grow">
              ...
              <div class="text-base font-normal text-gray-500 dark:text-gray-400">Get an email when a Dribbble Meetup is
          ...
          <div class="flex items-center justify-between pt-4">
            <div class="flex flex-col flex-grow">
              ...
              <div class="text-base font-normal text-gray-500 dark:text-gray-400">Get Themsberg news, announcements, and
                product updates</div>
            </div>
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <div class="flex items-center justify-between py-4">
            <div class="flex flex-col flex-grow">
              ...
              <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an email when someone comments
          ...
          <div class="flex items-center justify-between pt-4">
            <div class="flex flex-col flex-grow">
              ...
              <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an email when someone leaves a
