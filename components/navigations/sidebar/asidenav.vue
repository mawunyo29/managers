...
const dropdownAuths = ref([
  ...
  { name: 'Profile lock', link: '/auth/users' }
])
...
<template>
   <aside id="sidebar"
        class="fixed top-0 left-0 z-20 sm:flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
        aria-label="Sidebar">
        <div
          ...
          <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto scroll-m-1">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
              <ul class="pb-2 space-y-2 " ref="sideNav">
                ...
                <li>
                  <NuxtLink :to="`/auth/users/${authUser?.name}/badging`"
                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700 ">
                ...
                <li>
                  ...
                  <TransitionGroup tag="ul" @before-enter="beforeEnter" @enter="enter" @before-leave="beforeLeave"
                    @leave="leave" class="py-2 space-y-2 overflow-hidden transition open-container max-h-0"
                    id="dropdown-auth">
                <li v-for="(authenticatenav, index) in dropdownAuths" :data-index="index" :key="authenticatenav.name">
                  <NuxtLink  :to="authenticatenav.link"
