    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="#" class="flex ml-2 md:mr-24">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">THE GOAL </span>
        </a>
      ...
      <div class="flex items-center ">
          ...
          <!-- Notifications -->
          <button @click="openNotification()" type="button" data-dropdown-toggle="notification-dropdown" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 .dropdown" ref="notificationDropDown" >
            <span class="sr-only">View notifications</span>
            <!-- Bell icon -->
            <svg class="w-6 h-6 .dropdown" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"></path></svg>
          </button>
          <!-- Dropdown menu -->
          <user-notification :notification="notificationDropDown"   @update:notificaiton="openNotification" :isOpenNotification="isOpenNotification" />
          <!-- Apps -->
          <button @click="openApps()" type="button" data-dropdown-toggle="apps-dropdown" class="hidden p-2 text-gray-500 rounded-lg sm:flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700" ref="appDropDown">
            <span class="sr-only">View notifications</span>
            <!-- Icon -->
          ...
          <!-- Dropdown menu -->
          <app-card :isOpen="isOpenApp"  :toggleEvent="appDropDown" @update:isOpen="openApps()"  />
          <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 border">
