<template>
  <!-- <TransitionRoot :show="isOpen" as="div" class="absolute top-16 right-6">
    <TransitionChild enter="transition ease-in-out duration-300 transform" enter-from="translate-x-full origin-right"
      ...
      <div
        class="  z-50 .dropdown max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 ">
        <div
  ...
  <button-events :toggleOpen="isOpen" :buttonEvent="toggleEvent" @update:clickOutside="emitToggle" >
    <div
        class=" z-50 .dropdown max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 ">
        <div
          class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
...
const emitToggle = () => {
  return emit('update:isOpen', false)
}
// const buttonState = useButtonState()
const toggleEvent = computed(() => props.toggleEvent)

// watchEffect(() => {

//   if (!buttonState.isClickedState && buttonState.IsClicked) {
//     emitToggle()
//   }
...
//     //     // Vérifie si le clic est en dehors du dropdown et du bouton de bascule
//     //     if (!toggleEvent.value.contains(e.target)) {
//     //         emit('update:isOpen', false);
//     //         window.removeEventListener('click', clickHandler);
//     //     }
//     // };

//     // // Ajoute un écouteur d'événements au clic à l'ouverture du dropdown
//     // window.addEventListener('click', clickHandler);
  
// });
// onUpdated(() => {
//   buttonState.IsClicked = isOpen.value
//     buttonState.elementClicked = toggleEvent.value
//     buttonState.listenForClickOutside(buttonState.IsClicked, buttonState.elementClicked)
